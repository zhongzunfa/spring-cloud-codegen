 ...
 */
public class ConfigPomXmlGenerator extends CodeGenForFileGenerator{

    public ConfigPomXmlGenerator(InputParamsContext inputParamsContext) {
        super(inputParamsContext);
    }
